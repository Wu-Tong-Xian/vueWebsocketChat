          ...
          <div class="box7">
            ...
            <div class="chat-box" id="scrolldIV">
              ...
              <div v-for="(item,index) in message" :key="index">
                <!-- 如果有加入 或者有退出 -->
                <div v-if="item.jru || item.tchu || item.current">
                  <!-- 加入群聊 -->
                  ...
                  <!-- 发送消息时显示时间 -->
                  <div v-if='item.current' class="t-center fz14 colg" >{{item.current}}</div>
                </div>
