              ...
              <div v-for="(item,index) in message" :key="index">
                ...
                <div v-else>
                  ...
                  <div v-if="title !== item.username" class="fl">
                    ...
                    <!-- 发送的图片 -->
                    <img  v-if="item.img" style="max-width: 350px; max-height: 450px;"  :src="item.img" alt="">
                  </div>
                  <!-- 当前用户输入信息 显示在右边-->
                  <div v-if="title === item.username" class="over-flaot">
                   ...
                   <!-- 发送的图片 -->
                    <img  v-if="item.img" style="max-width: 300px; max-height: 400px;" class=" right" :src="item.img" alt="">
                  </div>
                </div>
              </div>
            </div>
